...
public class MuleComponent {
  ...
  public Map<String,String> processString(String input) {
	...
	public Map<String, Object> processAll(@Payload Object input, @InboundHeaders(value = "http.method") String method) {
		Map<String, Object> output = new HashMap<String, Object>();
		output.put("message", input.toString());
		output.put("http.method", method);
		output.put("processed by", "processAl");
		output.put("currentCounter", count);
		count++;
		return output;
	}
